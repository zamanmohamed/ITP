	...
	if (isset($_POST['submit'])) {
		...
		if (empty($errors)) {
			...
			if (mysqli_num_rows($result_set) == 1) {
				...
				// updating last login
				$query = "UPDATE customer SET last_login = NOW() ";
				$query .= "WHERE customer_id = {$_SESSION['customer_id']}  LIMIT 1";
...
<!-- Page Preloder -->
	...
	<div class="login">
		...
		<form action="customer-login.php" method="post">
			...
			<fieldset>
				<legend><h2>customer Log In</h2></legend>
				...
				<p>
					<label for="">Not Registered? </label><a href="customer-registration.php">Create an account</a>
				</p>
				
				<p>
					<label for="">Forgot Password? </label><a href="requestpassword.php">forgot password</a>
				</p>
