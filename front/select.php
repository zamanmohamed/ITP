	...
	<div class="login" align="center">
		...
		<form >
			...
			<fieldset>
				...
				<p>
					<a style='width:100px;' href="customer-login.php" class='btn btn-primary'>Customer</a>
					
				</p>

				<p>
					<a style='width:100px;' href="supplier-login.php" class='btn btn-primary'>Supplier</a>
				</p>

				<p>
					<a href="../admin/admin-login.php" style='width:100px;' class='btn btn-primary'>Admin</a>
				</p>
