	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="side-nav">
				...
				<ul class="side-nav nav navbar-nav ">
					...
					<li>
                        <a href="http://localhost/ITP2/O_delivery/public/getname/<?php echo $_SESSION['first_name']; ?>" data-toggle="collapse" data-target="#demo7"><i class="fa fa-fw fa-arrows-v"></i> Delivery management <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="demo7" class="collapse">
                            <li>
                                <a href="http://localhost/ITP2/O_delivery/public/qcwelcome"> Orders </a>
                            </li>
                            <li>
                                <a href="http://localhost/ITP2/O_delivery/public/CheckingItem">Insert Item For QC checking</a>
                            </li>
                            <li>
                                <a href='http://localhost/ITP2/O_delivery/public/qcitem'>QC</a>
                            </li>
                            <li>
                                <a href='http://localhost/ITP2/O_delivery/public/accepted'>QC accepted item</a>
                            </li>
                            <li>
                                <a href='http://localhost/ITP2/O_delivery/public/qcitem'>QC rejected item</a>
                            </li>
                            <li>
                                <a href='http://localhost/ITP2/O_delivery/public/deliveryItem'>Deliverd item</a>
                            </li>
                            <li>
                                <a href='http://localhost/ITP2/O_delivery/public/pieChartReport'>Report</a>
                            </li>
                                </ul>
                            </li>
